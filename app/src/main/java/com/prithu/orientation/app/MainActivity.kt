package com.prithu.orientation.app
...
import com.prithu.orientation.app.R

class MainActivity : AppCompatActivity() {

    private lateinit var orientationText: TextView
    private var imuInterface: com.launcher.sensordata.aidl.ImuInterface? = null
    ...
    private fun getDataFromAIDL() {
        imuInterface?.imuDataProvider()?.let {
    ...
    private fun bindOrientationService() {
        ...
        orientationServiceConnection = object : ServiceConnection {
            override fun onServiceConnected(componentName: ComponentName?, binder: IBinder?) {
                imuInterface = com.launcher.sensordata.aidl.ImuInterface.Stub.asInterface(binder)
                getDataFromAIDL()
            }
